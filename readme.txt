...
1. Photo Map Example 1: Cape Town Tourist Attractions
2. Photo Map Example 2: The Best Beaches in the World
3. Photo Map Example 3 (pro version): Famous Museums
4. Photo Map Example 4 (pro version): Safari Trip 
5. Photo Map Example 5 (pro version): Apartment For Rent in New York 
6. Photo Map Example 6 (pro version): Mapping Instagram Photos 
7. Photo Map Manager - create, administer and delete your photo maps from here.
8. Easily upload photos in the photo admin screen
9. Indicate the photo's location by entering the marker's address (auto-prompts assist with address selection). For photos already containing geolocation data, this step is not necessary. 
